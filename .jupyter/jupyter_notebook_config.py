...
#  Default: ''
c.NotebookApp.browser = 'explorer.exe'
...
#  Choices: any of ['sha256', 'sha3_384', 'sha1', 'sha224', 'md5', 'sha384', 'blake2b', 'blake2s', 'sha3_512', 'sha3_224', 'sha512', 'sha3_256']
#  Default: 'sha256'
